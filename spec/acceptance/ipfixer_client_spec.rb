...
describe "installation/ uninstallation" do
  ...
  it "should be able to find the root of the gem when it's installed", :current => true do
    @installer.get_root_of_gem.should eq(get_project_dir_from_tests)
  end
  
  it "should be able to create it's log files", :current => true do
